...
I am not your personal tutor, so please try attending assigned office hours, asking questions first on our [campuswire](https://campuswire.com), and collaborating with classmates. If you are still struggling or can't resolve your issues feel free to set up an appointment with me. 
...
Briefly explain what you are struggling with and insert screenshots of error messages *(If its R code related)*
...
2. not including images of code errors *(if its R code related only)*
