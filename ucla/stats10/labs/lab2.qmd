...
The above will output the following error
```
Error in c(TRUE, TRUE, FALSE, FALSE) || c(TRUE, FALSE, TRUE, FALSE) : 
  'length = 4' in coercion to 'logical(1)'
```

A better example for single comparisons would be as follows
