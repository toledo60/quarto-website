...
```{r}
ozone_dat <- read.table(file = "/Users/toledo60/Desktop/Projects/personal-website/data/ozone.txt", 
                        header =TRUE)
```
...
```{r}
wrong_ozone_dat <- read.table(file = "/Users/toledo60/Desktop/Projects/personal-website/data/ozone.txt")
```
