...
```
1. Flip 10 unfair coins, in this case it is less likely to obtain a head for each toss
...
result
```
1. Randomly flip a coin 5 times and replicate this procedure two times
