...
We will use VS code throughout this tutorial. First create a folder with an appropriate name, in your desired destination. I will create a folder called `simple_app` in my `Desktop` directory.
